...
export default function HomePage() {
  ...
  return (
    <div className="page-shell">
      <Head>
          <title>CrossLedger (CLXT) Ã¢ÂÂ Blockchain Trade Infrastructure Token | Presale Live</title>
          ...
          <meta property="og:title" content="CrossLedger (CLXT) Ã¢ÂÂ Blockchain Trade Infrastructure Token | Presale Live" />
          ...
          <meta name="twitter:title" content="CrossLedger (CLXT) Ã¢ÂÂ Blockchain Trade Infrastructure Token" />
            ...
            <section className="content-card glass">
              ...
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:"14px"}}>
                <div style={{background:"rgba(0,194,212,0.08)",border:"1px solid rgba(0,194,212,0.18)",borderRadius:"12px",padding:"18px"}}>
                  <div style={{fontSize:"1.6rem",marginBottom:"8px"}}>Ã¢ÂÂ¡</div>
                ...
                <div style={{background:"rgba(0,194,212,0.08)",border:"1px solid rgba(0,194,212,0.18)",borderRadius:"12px",padding:"18px"}}>
                  <div style={{fontSize:"1.6rem",marginBottom:"8px"}}>Ã°ÂÂÂ</div>
                ...
                <div style={{background:"rgba(0,194,212,0.08)",border:"1px solid rgba(0,194,212,0.18)",borderRadius:"12px",padding:"18px"}}>
                  <div style={{fontSize:"1.6rem",marginBottom:"8px"}}>Ã¢ÂÂÃ¯Â¸Â</div>
          ...
          <div className="right-col">
            ...
            <section className="content-card glass">
              ...
              <div className="team-item">
                <strong>Gui Di Nardo Ã¢ÂÂ Co-Founder & CEO</strong>
              ...
              <div className="team-item">
                <strong>Tom Young Ã¢ÂÂ Co-Founder & CTO</strong>
        ...
        <section id="blog" style={{padding:"60px 20px",maxWidth:"1100px",margin:"0 auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:"28px"}}>
            ...
            <article style={{background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"16px",padding:"28px",display:"flex",flexDirection:"column"}}>
              ...
              <p style={{fontSize:"0.9rem",color:"rgba(255,255,255,0.7)",lineHeight:1.7,marginBottom:"16px",flexGrow:1}}>Most utility tokens described at launch never develop genuine on-chain utility. CLXT is designed differently: token demand is directly tied to transaction volume on the CrossLedger platform, not to speculative market sentiment. Every trade financed through the platform requires CLXT for fee settlement, staking collateral, and dispute arbitration. As transaction volume grows Ã¢ÂÂ driven by real commercial trade flows in agriculture, energy, and industrial goods Ã¢ÂÂ demand for CLXT increases proportionally. The tokenomics are structured to prevent early dumping: 40 percent of the total supply is allocated to the ecosystem and liquidity reserves with a 24-month vesting schedule, team tokens are locked for 18 months post-launch, and presale participants receive a staking bonus for holding rather than selling immediately. The presale price of $0.003 per CLXT reflects the early-stage risk premium, with projected platform revenue providing a fundamental valuation anchor once live trade volumes are established. Investors who understand trade finance fundamentals Ã¢ÂÂ not just crypto cycles Ã¢ÂÂ represent CrossLedger's core audience.</p>
              <span style={{fontSize:"0.82rem",color:"#00C2D4",fontWeight:600}}>Read Article &rarr;</span>
            </article>
            <article style={{background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"16px",padding:"28px",display:"flex",flexDirection:"column"}}>
        ...
        <div style={{maxWidth:"960px",margin:"0 auto",padding:"40px 24px 24px"}}>
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(160px,1fr))",gap:"28px",marginBottom:"36px"}}>
            ...
            <div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:"7px"}}>
                <a href={`https://etherscan.io/address/${PRESALE_CONTRACT_ADDRESS}`} target="_blank" rel="noreferrer" style={{color:"#475569",fontSize:"0.8rem",textDecoration:"none"}}>Presale Contract Ã¢ÂÂ</a>
                <a href={`https://etherscan.io/token/${CLX_TOKEN_ADDRESS}`} target="_blank" rel="noreferrer" style={{color:"#475569",fontSize:"0.8rem",textDecoration:"none"}}>Token Contract Ã¢ÂÂ</a>
                <a href={`https://etherscan.io/token/${USDT_TOKEN_ADDRESS}`} target="_blank" rel="noreferrer" style={{color:"#475569",fontSize:"0.8rem",textDecoration:"none"}}>USDT on Etherscan Ã¢ÂÂ</a>
                <a href="/CrossLedger-CLXT-Whitepaper.pdf" target="_blank" rel="noreferrer" style={{color:"#475569",fontSize:"0.8rem",textDecoration:"none"}}>Whitepaper Ã¢ÂÂ</a>
              </div>
            </div>
            <div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:"7px"}}>
                <a href="https://x.com/CrossLedgerCLX" target="_blank" rel="noreferrer" style={{color:"#475569",fontSize:"0.8rem",textDecoration:"none"}}>Follow on X Ã¢ÂÂ</a>
          ...
          <div style={{borderTop:"1px solid rgba(255,255,255,0.06)",paddingTop:"18px",display:"flex",flexWrap:"wrap",justifyContent:"space-between",alignItems:"center",gap:"10px"}}>
            <span style={{color:"#334155",fontSize:"0.73rem"}}>ÃÂ© 2025 GDN Enterprise Pty Ltd · CrossLedger &amp; CLXT Token</span>
